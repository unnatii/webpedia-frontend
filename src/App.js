...
import {SignInPage ,SignUpPage,HomePage,
      NewPasswordPage,ResetPasswordPage} from './Pages'
...
const  App=(props)=> {
  ...
  return (
    <Switch>
      ...
      <Route path="/reset/:user/:token" exact component={NewPasswordPage} /> 
       <AuthRoute path="/reset" exact component={ResetPasswordPage} />
      <AuthRoute path="/signup" component={SignUpPage}  auth={props.authenticated} >        
      </AuthRoute>
